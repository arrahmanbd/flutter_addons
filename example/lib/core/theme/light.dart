...
class AppLightColors extends ThemeKolors {
  ...
  @override
  Color get shadowColor => Kolors.neutral900.withValues(alpha: 0.08); // light shadow
}
...
class AppDarkColors extends ThemeKolors {
  ...
  @override
  Color get shadowColor => Kolors.neutral900.withValues(alpha: 0.5); // subtle elevation
}
