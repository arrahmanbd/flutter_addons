...
extension UnifiedMarginPadding on int {
  ...
  EdgeInsets get mx =>
      EdgeInsets.symmetric(horizontal: rs); // margin horizontal (x)
  EdgeInsets get my =>
      EdgeInsets.symmetric(vertical: rs); // margin vertical (y)
  ...
  EdgeInsets get px =>
      EdgeInsets.symmetric(horizontal: rs); // padding horizontal (x)
  EdgeInsets get py =>
      EdgeInsets.symmetric(vertical: rs); // padding vertical (y)
