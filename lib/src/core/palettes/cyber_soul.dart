...
class CyberLight extends ThemeKolors {
  ...
  @override
  Color get cardBackground => const Color(0xFFD9BFD8);
  @override
  Color get secondaryContent => const Color(0xFFA8A8A8);
  @override
  Color get inputBackground => const Color(0xFFF0C5D3);
  @override
  Color get outlineColor => const Color(0xFFC8A3CF);
  @override
  Color get dividerColor => const Color(0xFFB78BBE);
  @override
...
class CyberDark extends ThemeKolors {
  ...
  @override
  Color get cardBackground => const Color(0xFF252525);
  @override
  Color get secondaryContent => const Color(0xFFB8B8B8);
  @override
  Color get inputBackground => const Color(0xFF333333);
  @override
  Color get outlineColor => const Color(0xFF4A4A4A);
  @override
  Color get dividerColor => const Color(0xFF414141);
  @override
  Color get shadowColor => const Color(0x1A000000);
  @override
  Color get secondaryButton => const Color(0xFFC23C6D);
}
